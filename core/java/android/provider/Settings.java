...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
         ...
         * @hide
         */
        public static final String DOUBLE_TAP_TO_SLEEP_STATUS_BAR = "double_tap_to_sleep_status_bar";
         ...
         * @hide
         */
        public static final String STATUS_BAR_CLOCK_COLOR_OVERRIDE = "status_bar_clock_color_override";
        ...
        /**
         * Whether the user has enabled Heads up (Default 1)
         * Heads up is enabled by default within its Settings.Global.HEADS_UP_NOTIFICATIONS_ENABLED
        ...
        /**
         * Boolean value for whether to show weather in the expanded status bar
         * @hide
         */
        ...
        /**
         * Network status color style
         * @hide
         */
        public static final String NETWORK_TRAFFIC_COLOR = "network_traffic_color";

        /**
         * Network status color override
         * @hide
         */
        public static final String NETWORK_TRAFFIC_COLOR_OVERRIDE = "network_traffic_color_override";
    ...
    public static final class Secure extends NameValueTable {
        ...
        /**
         * Whether to include options in the power menu for rebooting into recovery and bootloader
         * @hide
         */
