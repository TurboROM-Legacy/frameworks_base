...
class GlobalActions implements DialogInterface.OnDismissListener, DialogInterface.OnClickListener  {
    ...
    private GlobalActionsDialog createDialog() {
        ...
        ArrayList<ActionConfig> globalMenuConfig =
                ActionHelper.getGlobalMenuConfigWithDescription(
                mContext, "shortcut_action_global_menu_values",
                "shortcut_action_global_menu_entries");

        ArraySet<String> addedKeys = new ArraySet<String>();
        for (final ActionConfig config : globalMenuConfig) {
            ...
            Drawable icon = ActionHelper.getGlobalMenuIconImage(mContext, actionKey, config.getIcon());
            if (icon != null) {
                icon = ImageHelper.resize(mContext, icon, 36);
            }

            if (actionKey.equals(ActionConstants.ACTION_POWER_OFF)) {
                mItems.add(getPowerAction(icon));
            } else if (actionKey.equals(ActionConstants.ACTION_REBOOT)) {
            ...
            } else if (actionKey.equals(ActionConstants.ACTION_LOCKDOWN)) {
    ...
    /**
     * Functions needed for screenrecord
     */
