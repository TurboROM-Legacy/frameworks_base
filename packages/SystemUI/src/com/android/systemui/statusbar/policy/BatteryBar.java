...
public class BatteryBar extends RelativeLayout implements Animatable {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observer() {
            ...
            resolver.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.STATUS_BAR_BATTERY_BAR), false, this);
            resolver.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.STATUS_BAR_BATTERY_BAR_COLOR), false,
                    this);
            resolver.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.STATUS_BAR_BATTERY_BAR_ANIMATE),
                    false, this);
        }
    ...
    private void updateSettings() {
        ...
        int color = Settings.System.getInt(resolver, Settings.System.STATUS_BAR_BATTERY_BAR_COLOR,
                0xFFFFFFFF);
