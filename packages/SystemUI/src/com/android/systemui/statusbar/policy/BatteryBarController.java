...
public class BatteryBarController extends LinearLayout {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observer() {
            ...
            resolver.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.STATUS_BAR_BATTERY_BAR_STYLE), false,
                    this);
            resolver.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.STATUS_BAR_BATTERY_BAR_THICKNESS),
                    false, this);
        }
    ...
    public void updateSettings() {
        ...
        mLocation = Settings.System.getInt(getContext().getContentResolver(),
                Settings.System.STATUS_BAR_BATTERY_BAR, 0);
