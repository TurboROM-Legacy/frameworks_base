...
public class MinitBatteryController implements
    ...
    private ArrayList<MinitBattery> mMinitList = new ArrayList<MinitBattery>(3);
    ...
    public MinitBatteryController(Context context,
            PhoneStatusBarView statusbarView, StatusBarHeaderView header,
            KeyguardStatusBarView keyguardView) {
        mContext = context;
        mResolver = context.getContentResolver();

        // get our 3 instances from all over SystemUILand
        ViewGroup systemIcons = (ViewGroup) header
                .findViewById(R.id.system_icons);
        ...
        mMinitList.add((MinitBattery) systemIcons
                .findViewById(R.id.minitBattery));
