...
import com.android.systemui.slimrecents.RecentController;
...
public abstract class BaseStatusBar extends SystemUI implements
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        public void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.HEADS_UP_WHITELIST_VALUES), false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
        ...
        private void update() {
            ...
            final String whiteString = Settings.System.getStringForUser(resolver,
                    Settings.System.HEADS_UP_WHITELIST_VALUES, UserHandle.USER_CURRENT);
    ...
    public static void updatePreferences() {
        ...
        for (Entry entry : mNotificationData.getActiveNotifications()) {
            NotificationBackgroundView mBackgroundNormal = (NotificationBackgroundView)
                    getObjectField(entry.row, "mBackgroundNormal");
            NotificationBackgroundView mBackgroundDimmed = (NotificationBackgroundView)
                    getObjectField(entry.row, "mBackgroundDimmed");
    ...
    private static Field findFieldRecursiveImpl(Class<?> clazz, String fieldName) throws
