        ...
        BlurTask.setBlurTaskCallback(new BlurUtils.BlurTaskCallback() {
            ...
            public void dominantColor(int color) {
                ...
                if (lightness >= 0.0 && color <= 1.0) {
                    if (lightness <= 0.33) {
                        mColorFilter = new PorterDuffColorFilter(mBlurLightColorFilter,
                                PorterDuff.Mode.MULTIPLY);

                    } else if (lightness >= 0.34 && lightness <= 0.66) {
                        mColorFilter = new PorterDuffColorFilter(mBlurMixedColorFilter,
                                PorterDuff.Mode.MULTIPLY);

                    } else if (lightness >= 0.67 && lightness <= 1.0) {
                        mColorFilter = new PorterDuffColorFilter(mBlurDarkColorFilter,
                                PorterDuff.Mode.MULTIPLY);
                    }
    ...
    public static class BlurTask extends AsyncTask<Void, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(Void... arg0) {
            ...
            try {
                ...
                mCallback.dominantColor(DisplayUtils.getDominantColorByPixelsSampling(
                        mScreenBitmap, 20, 20));
